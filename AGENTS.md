...
**Now:** execute the Skin + PWA plan (see `docs/STATUS.md`). PrimeVue stays out. Do not claim Skin is live. Do not start Deploy. Do not start a slice that STATUS does not name.
