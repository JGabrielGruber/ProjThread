...
| **24. PWA share target** | `2026-09-04-projthread-capture-share.md` | Manifest `share_target` POST; `/capture` landing; text/url + image blobs. **Open.** |
