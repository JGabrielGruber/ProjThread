...
| **24** | PWA share target | Manifest `share_target`; text/url landing route; files after 22. Same graph and project picker. SW still skips `/api/*` and WS. Plan: `docs/superpowers/plans/2026-09-04-projthread-capture-share.md`. **Open.** | none new |
